                                        ...
                                        <div class="border-0">
                                            ...
                                            <div id="cityCategoryOne" class="collapse show" aria-labelledby="cityCategoryHeadingOne" data-parent="#cityCategoryAccordion">
                                                <div class="card-body pt-0 mt-1 px-5 pb-4">
                                                    ...
                                                    <!-- Link -->
                                                    <a class="link link-collapse small font-size-1 mt-2" data-toggle="collapse" href="tour-list.html#collapseBrand3" role="button" aria-expanded="false" aria-controls="collapseBrand3">
                ...
                <div class="col-lg-8 col-xl-9 order-md-1 order-lg-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="nav tab-nav-shop flex-nowrap" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link font-size-22 p-0" id="pills-three-example1-tab" data-toggle="pill" href="tour-list.html#pills-three-example1" role="tab" aria-controls="pills-three-example1" aria-selected="true">
                            ...
                            <li class="nav-item">
                                <a class="nav-link font-size-22 p-0 ml-2 active" id="pills-one-example1-tab" data-toggle="pill" href="tour-list.html#pills-one-example1" role="tab" aria-controls="pills-one-example1" aria-selected="false">
                                    <div class="d-md-flex justify-content-md-center align-items-md-center">
                                        <i class="fa fa-th"></i>
                                    </div>
                                </a>
                    ...
                    <div class="u-slick__tab">
                        ...
                        <div class="mb-5">
                            <ul class="nav flex-nowrap border border-radius-3 tab-nav align-items-center py-2 px-0" role="tablist">
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1">
                                    <a href="tour-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Recommended
                                    </a>
                                </li>
                                ...
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="tour-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Guest Rating
                                    </a>
                                </li>
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="tour-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Distance
                                    </a>
                                </li>
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="tour-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Top Reviewed
                                    </a>
                                </li>
                            </ul>
                        </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                                                ...
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img1.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img2.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img3.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img4.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img5.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img6.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="border-xl-left border-color-7">
                                                        <div class="ml-md-4 ml-xl-0">
                                                            ...
                                                            <div class="d-flex justify-content-center justify-content-md-start justify-content-xl-center">
                                                                <a href="{{route("tour_single")}}" class="btn btn-outline-primary d-flex align-items-center justify-content-center font-weight-bold min-height-50 border-radius-3 border-width-2 px-2 px-5 py-2">View Detail</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                                                ...
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img48.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img4.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img49.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img50.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img51.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img52.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img51.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img50.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img49.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img48.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img1.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                                                 ...
                                                                 data-pagi-classes="js-pagination text-center u-slick__pagination u-slick__pagination--white position-absolute right-0 bottom-0 left-0 mb-3 mb-0">
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img4.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img5.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img9.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img50.jpg")}}"></a>
                                                                </div>
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img3.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="img-fluid min-height-230" src="{{asset("assets-open/img/300x230/img48.jpg")}}"></a>
                                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img1.jpg")}}" alt="img">
                                                </a>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                <a href="{{route("tour_single")}}" class="d-block">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title font-size-17 font-weight-bold mb-0 text-dark">Stonehenge, Windsor Castle,<br>and Bath from London</a>
                                                <div class="my-2">
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img2.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 left-0 pt-5 pl-3">
                                                    <span class="badge badge-pill bg-white text-danger px-3 ml-3 py-2 font-size-14 font-weight-normal">%25</span>
                                                </div>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">Bosphorus Strait and Black Sea Half-Day Cruise from Istanbul</a>
                                                <div class="my-2">
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img3.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart font-size-20"></span>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">NYC One World Observatory Skip-the-Line Ticket</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img4.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart font-size-20"></span>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">Small-Group Blue Mountains Day Trip from Sydney with River Cruise</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img48.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 left-0 pt-5 pl-3">
                                                    <span class="badge badge-pill bg-white text-danger px-3 ml-3 py-2 font-size-14 font-weight-normal">%25</span>
                                                </div>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold pr-xl-3">Africa – Amazing African Safari</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img49.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart font-size-20"></span>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">Enquiry Form Only  <br> Paris – 6 Days</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img50.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart font-size-20"></span>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold pr-xl-3">Venice, Rome and Milan – <br> 9 Days 8 Nights</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img51.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 left-0 pt-5 pl-3">
                                                    <span class="badge badge-pill bg-white text-danger px-3 ml-3 py-2 font-size-14 font-weight-normal">%25</span>
                                                </div>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">Molokini and Turtle Arches Snorkeling Trip</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative mb-2">
                                                <a href="{{route("tour_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img52.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart font-size-20"></span>
                                            ...
                                            <div class="card-body px-4 py-2">
                                                ...
                                                <a href="{{route("tour_single")}}" class="card-title text-dark font-size-17 font-weight-bold">Two Capitals Tour of 7 days and 6 nights From Moscow</a>
                                                <div class="my-2">
                                                    <div class="d-inline-flex align-items-center font-size-17 text-lh-1">
                                                        <div class="green-lighter mr-2">
                                                            <small class="fas fa-star"></small>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="list-pagination-1 pagination border border-color-4 rounded-sm overflow-auto overflow-xl-visible justify-content-md-center align-items-center py-2 mb-0">
                                <li class="page-item">
                                    <a class="page-link border-right rounded-0 text-gray-5" href="tour-list.html#" aria-label="Previous">
                                        <i class="flaticon-left-direction-arrow font-size-10 font-weight-bold"></i>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                </li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">1</a></li>
                                <li class="page-item"><a class="page-link font-size-14 active" href="tour-list.html#">2</a></li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">3</a></li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">4</a></li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">5</a></li>
                                <li class="page-item disabled"><a class="page-link font-size-14" href="tour-list.html#">...</a></li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">66</a></li>
                                <li class="page-item"><a class="page-link font-size-14" href="tour-list.html#">67</a></li>
                                <li class="page-item">
                                    <a class="page-link border-left rounded-0 text-gray-5" href="tour-list.html#" aria-label="Next">
