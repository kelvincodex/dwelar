            ...
            <div class="row mb-5 mb-lg-8 mt-xl-1">
                                                ...
                                                <div class="border-bottom border-width-2 border-color-1">
                                                    ...
                                                    <div id="basicDropdownClick" class="dropdown-menu dropdown-unfold col m-0" aria-labelledby="basicDropdownClickInvoker">
                                                        ...
                                                        <div class="w-100 text-right py-1 pr-5">
                                                            <a class="text-primary font-weight-semi-bold font-size-16" href="hotel-list.html#">Done</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="pb-4 mb-2">
                                    <a href="hotel-list.html#ontargetModal" class="d-block border rounded"
                                       ...
                                       data-modal-effect="fadein">
                                        <img src="{{asset("assets-open/img/map-markers/map.jpg")}}" alt="" width="100%">
                                    </a>
                                    <!-- On Target Modal -->
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img58.jpg")}}"></a>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="position-absolute bottom-0 left-0 right-0">
                                                                                            <div class="px-4 pb-3">
                                                                                                <a href="hotel-list.html#" class="d-block">
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img3.jpg")}}"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("assets-open/img/300x230/img62.jpg")}}"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("")}}../../assets-open/img/300x230/img63.jpg"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("")}}../../assets-open/img/300x230/img9.jpg"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                                                        ...
                                                                        <div class="product-item__outer w-100">
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="product-item__header">
                                                                                        <div class="position-relative">
                                                                                            <a href="hotel-list.html#" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-150 card-img-top" src="{{asset("")}}../../assets-open/img/300x230/img10.jpg"></a>
                                                                                        </div>
                                                                                        <div class="position-absolute top-0 left-0 pt-3 pl-4">
                                                                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                                                                <span class="flaticon-valentine-heart"></span>
                                        ...
                                        <div class="border-0">
                                            ...
                                            <div id="facilityCategoryOne" class="collapse show" aria-labelledby="facilityCategoryHeadingOne" data-parent="#facilityCategoryAccordion">
                                                <div class="card-body pt-0 mt-1 px-5 pb-4">
                                                    ...
                                                    <!-- Link -->
                                                    <a class="link link-collapse small font-size-1" data-toggle="collapse" href="hotel-list.html#collapseBrand1" role="button" aria-expanded="false" aria-controls="collapseBrand1">
                                        ...
                                        <div class="border-0">
                                            ...
                                            <div id="propertyCategoryOne" class="collapse show" aria-labelledby="propertyCategoryHeadingOne" data-parent="#propertyCategoryAccordion">
                                                <div class="card-body pt-0 mt-1 px-5 pb-4">
                                                    ...
                                                    <!-- Link -->
                                                    <a class="link link-collapse small font-size-1" data-toggle="collapse" href="hotel-list.html#collapseBrand2" role="button" aria-expanded="false" aria-controls="collapseBrand2">
                                        ...
                                        <div class="border-0">
                                            ...
                                            <div id="cityCategoryOne" class="collapse show" aria-labelledby="cityCategoryHeadingOne" data-parent="#cityCategoryAccordion">
                                                <div class="card-body pt-0 mt-1 px-5 pb-4">
                                                    ...
                                                    <!-- Link -->
                                                    <a class="link link-collapse small font-size-1" data-toggle="collapse" href="hotel-list.html#collapseBrand3" role="button" aria-expanded="false" aria-controls="collapseBrand3">
                ...
                <div class="col-lg-8 col-xl-9 order-md-1 order-lg-2 pb-5 pb-lg-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1">London: 3292 hotels found</h3>
                        <ul class="nav tab-nav-shop flex-nowrap" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link font-size-22 p-0" id="pills-three-example1-tab" data-toggle="pill" href="hotel-list.html#pills-three-example1" role="tab" aria-controls="pills-three-example1" aria-selected="true">
                            ...
                            <li class="nav-item">
                                <a class="nav-link font-size-22 p-0 ml-2 active" id="pills-one-example1-tab" data-toggle="pill" href="hotel-list.html#pills-one-example1" role="tab" aria-controls="pills-one-example1" aria-selected="false">
                                    <div class="d-md-flex justify-content-md-center align-items-md-center">
                                        <i class="fa fa-th"></i>
                                    </div>
                                </a>
                        ...
                        <div class="mb-5">
                            <ul class="nav flex-nowrap border border-radius-3 tab-nav align-items-center py-2 px-0" role="tablist">
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1">
                                    <a href="hotel-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Recommended
                                    </a>
                                </li>
                                ...
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="hotel-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Guest Rating
                                    </a>
                                </li>
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="hotel-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Distance
                                    </a>
                                </li>
                                <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                    <a href="hotel-list.html#" class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 ">Top Reviewed
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-three-example1" role="tabpanel" aria-labelledby="pills-three-example1-tab" data-target-group="groups">
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                ...
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img58.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img62.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5"><img class="img-fluid min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{asset("otel_singles")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img62.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img58.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img57.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img56.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                 ...
                                                                 data-pagi-classes="js-pagination text-center u-slick__pagination u-slick__pagination--white position-absolute right-0 bottom-0 left-0 mb-3 mb-0">
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img62.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img57.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img58.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{asset("otel_singles")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img62.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                 ...
                                                                 data-pagi-classes="js-pagination text-center u-slick__pagination u-slick__pagination--white position-absolute right-0 bottom-0 left-0 mb-3 mb-0">
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img11.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img9.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img10.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img12.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img13.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img63.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img9.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                 ...
                                                                 data-pagi-classes="js-pagination text-center u-slick__pagination u-slick__pagination--white position-absolute right-0 bottom-0 left-0 mb-3 mb-0">
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-oen/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                                ...
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img13.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img10.jpg")}}"></a>
                                                                </div>
                                            ...
                                            <div class="row align-items-center">
                                                    ...
                                                    <div class="product-item__header">
                                                        <div class="position-relative">
                                                            <div class="js-slick-carousel u-slick u-slick--equal-height "
                                                                 ...
                                                                 data-pagi-classes="js-pagination text-center u-slick__pagination u-slick__pagination--white position-absolute right-0 bottom-0 left-0 mb-3 mb-0">
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img10.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img22.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img33.jpg")}}"></a>
                                                                </div>
                                                                <div class="js-slide w-100">
                                                                    <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5 w-100"><img class="min-height-230 card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-7 col-xl-5 col-wd-4gdot5 flex-horizontal-center">
                                                    <div class="w-100 position-relative m-4 m-md-0">
                                                        ...
                                                        <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html">
                                                            <span class="font-weight-medium font-size-17 text-dark d-flex mb-1">Empire Prestige Causeway Bay </span>
                                                        </a>
                                                        <div class="card-body p-0">
                                                            <a href="https://transvelo.github.io/mytravel-html/html/hotels/hotels-single-v2.html" class="d-block mb-3">
                                                                <div class="d-flex flex-wrap flex-xl-nowrap align-items-center font-size-14 text-gray-1">
                                                                    <i class="icon flaticon-placeholder mr-2 font-size-20"></i> Greater London, United Kingdom
                                                                    <small class="px-1 font-size-15"> - </small>
                                                                    <span class="text-primary font-size-14">View on map</span>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="list-pagination-1 pagination border border-color-4 rounded-sm overflow-auto overflow-xl-visible justify-content-md-center align-items-center py-2 mb-0">
                                        <li class="page-item">
                                            <a class="page-link border-right rounded-0 text-gray-5" href="hotel-list.html#" aria-label="Previous">
                                                <i class="flaticon-left-direction-arrow font-size-10 font-weight-bold"></i>
                                                <span class="sr-only">Previous</span>
                                            </a>
                                        </li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">1</a></li>
                                        <li class="page-item"><a class="page-link font-size-14 active" href="hotel-list.html#">2</a></li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">3</a></li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">4</a></li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">5</a></li>
                                        <li class="page-item disabled"><a class="page-link font-size-14" href="hotel-list.html#">...</a></li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">66</a></li>
                                        <li class="page-item"><a class="page-link font-size-14" href="hotel-list.html#">67</a></li>
                                        <li class="page-item">
                                            <a class="page-link border-left rounded-0 text-gray-5" href="hotel-list.html#" aria-label="Next">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img9.jpg")}}" alt="img">
                                                </a>
                                                ...
                                                <div class="position-absolute bottom-0 left-0 right-0">
                                                    <div class="px-4 pb-3">
                                                        <a href="{{route("hotel_single")}}" class="d-block">
                                                            <div class="d-flex align-items-center font-size-14 text-white">
                                            ...
                                            <div class="card-body pl-3 pr-4 pt-2 pb-3">
                                                ...
                                                <a href="{{route("hotel_single")}}" class="card-title font-size-17 font-weight-medium text-dark">Empire Prestige Causeway Bay</a>
                                                <div class="mt-2 mb-3">
                                                    <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                                    <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img10.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                            ...
                                            <div class="card-body pl-3 pr-4 pt-2 pb-3">
                                                ...
                                                <a href="{{route("hotel_single")}}" class="card-title font-size-17 font-weight-medium text-dark">Park Avenue Baker Street London</a>
                                                <div class="mt-2 mb-3">
                                                    <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                                    <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img12.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                            ...
                                            <div class="card-body pl-3 pr-4 pt-2 pb-3">
                                                ...
                                                <a href="{{route("hotel_single")}}" class="card-title font-size-17 font-weight-medium text-dark">New Road Hotel</a>
                                                <div class="mt-2 mb-3">
                                                    <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                                    <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img11.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                            ...
                                            <div class="card-body pl-3 pr-4 pt-2 pb-3">
                                                ...
                                                <a href="{{asset("hotel_single")}}" class="card-title font-size-17 font-weight-medium text-dark">New York Marriott Downtown</a>
                                                <div class="mt-2 mb-3">
                                                    <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                                    <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img57.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img58.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img59.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img60.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{route("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img62.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                        <span class="flaticon-valentine-heart"></span>
                                            ...
                                            <div class="card-body pl-3 pr-4 pt-2 pb-3">
                                                ...
                                                <a href="{{route("hotel_single")}}" class="card-title font-size-17 font-weight-medium text-dark">New York Marriott Downtown</a>
                                                <div class="mt-2 mb-3">
                                                    <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                                    <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 mb-md-4 pb-1">
                                        <div class="card transition-3d-hover shadow-hover-2 tab-card h-100">
                                            <div class="position-relative">
                                                <a href="{{asset("hotel_single")}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                    <img class="min-height-230 bg-img-hero card-img-top" src="{{asset("assets-open/img/300x230/img61.jpg")}}" alt="img">
                                                </a>
                                                <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
