                        ...
                        <div class="ml-md-6 ml-lg-0">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item mr-2">
                                    <a class="btn btn-icon btn-social btn-bg-transparent" href="index.html#">
            ...
            <div class="row d-block d-xl-flex align-items-md-center">
                <div class="col-xl-4 mb-4 mb-xl-0">
                    ...
                    <a class="d-inline-flex align-items-center" href="index.html" aria-label="MyTravel">
                        ...
                        <span class="brand brand-dark">{{env("APP_NAME")}}</span>
                    </a>
                    <!-- End Logo -->
                </div>
                <div class="bootstrap-select__custom col-xl-8 d-block d-lg-flex justify-content-xl-end align-items-center">
                    <div class="mb-4 mb-lg-0">
                        <ul class="d-flex list-unstyled mb-0">
                            <li class="mr-2 ml-0"><img class="max-width-40" src="{{asset("assets-open/img/icons/img3.png")}}" alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="{{asset("assets-open/img/icons/img4.png")}}" alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="{{asset("assets-open/img/icons/img5.png")}}" alt="Payment Icons"></li>
                            <li class="mx-2"><img class="max-width-40" src="{{asset("assets-open/img/icons/img6.png")}}" alt="Payment Icons"></li>
                            <li class="ml-2 mr--0"><img class="max-width-40" src="{{asset("assets-open/img/icons/img7.png")}}" alt="Payment Icons"></li>
                        </ul>
                    </div>
    ...
    <div class="space-1">
        <div class="container">
            <div class="d-lg-flex d-md-block justify-content-between align-items-center">
                <!-- Copyright -->
                <p class="text-muted mb-3 mb-lg-0 text-gray-1">© 2020 {{env("APP_NAME")}}. All rights reserved</p>
                <!-- End Copyright -->
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item  pb-3 pb-md-0">
                        <a class="list-group-item-action text-decoration-on-hover pr-3" href="home-v9.html">Yacht</a>
                    </li>
                    <li class="list-inline-item  pb-3 pb-md-0">
